...
# MiteMapTools <img src="man/figures/logo.png" align="right" height="139" alt="" />
...
# 1. MiteMap System → Raw ZIP files
# 2. import_mitemap() → Processed tracking data
# 3. filter_mitemap() → Clean data
# 4. Analysis functions → Results
# 5. Visualization functions → Plots and figures
```
...
- **Adrien Taudière** - Package development and maintenance
